...
*   **Authority hierarchy:** When this document and `INVARIANTS.md` disagree, `INVARIANTS.md` wins. It is schema-versioned (currently `v4`) and tracks what is actually enforced; this document is the narrative companion.
