...
| Blue Iris (NVR) | RTSP | up to 4K | ✅ Working | Acts as a camera proxy — any camera supported by Blue Iris works through its RTSP re-stream. Tested at 1296p via `/bird?h=1296`. | Community | 2026-09 |
